...
set_microstep_mode_full(lib, device_id)
...
# test_set_speed(lib, device_id, 600)
test_move(lib, device_id, 100000, ustartpos)
test_wait_for_stop(lib, device_id, 100)
# test_status(lib, device_id)
# test_serial(lib, device_id)
syncin_settings=get_syncin_settings(lib, device_id)
syncout_settings=get_syncout_settings(lib, device_id)
